...
{
    public class MobilePlayerCanvas : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_Run.gameObject.SetActive(false);
            m_PlayerGun = GetComponentInParent<Gun>();
        ...
        public void Shoot()
        {
            m_PlayerGun.ShootButton();
        }
        public void DisableShoot()
        {
            m_PlayerGun.EndShootButton();
        }
        public void Aim()
        {
            m_PlayerGun.AimButton();
        }
        public void Reload()
        {
            m_PlayerGun.MobileReload();
        }
        ...
        {
            if (m_RunEnabled == false)
            {
                m_RunEnabled = true;
                m_Run.SetActive(true);
            }
        }
